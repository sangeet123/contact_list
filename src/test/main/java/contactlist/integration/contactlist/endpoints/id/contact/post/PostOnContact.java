...
@SqlGroup({ @Sql(executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD, scripts = {
  ...
  @Test()
  public void test_empty_contact_email() throws Exception {
    final Map<String, String> map = new HashMap<>();
    map.put("firstName", "Ramesh");
    map.put("lastName", "Awasti");
    map.put("email", "");
  ...
  @Test()
  public void test_invalid_contact_email() throws Exception {
    final Map<String, String> map = new HashMap<>();
    map.put("firstName", "Ramesh");
    map.put("lastName", "Awasti");
  ...
  @Test()
  public void test_invalid_phone_number() throws Exception {
    final Map<String, String> map = new HashMap<>();
    map.put("firstName", "Ramesh");
    map.put("lastName", "Awasti");
    map.put("email", "Ramesh_Awasti@gmail.com");
  ...
  @Test()
  public void test_invalid_first_name_size_larger_than_30() throws Exception {
    final Map<String, String> map = new HashMap<>();
  ...
  @Test()
  public void test_invalid_last_name_size_larger_than_30() throws Exception {
    final Map<String, String> map = new HashMap<>();
    map.put("firstName", "Ramesh");
